...
class Container_548849654c extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\MainPresenter' => [1 => ['application.5']],
		...
		'services' => [
			...
			'application.5' => 'App\Presenters\MainPresenter',
	...
	{
		$service = new App\Presenters\LoginPresenter($this->getService('database.default.connection'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	{
		return new Container_548849654c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_548849654c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_548849654c $container)
	{
