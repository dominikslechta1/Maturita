<?php
// source: /var/www/clients/client92/web94/web/maturita/app/config/config.neon 
// source: /var/www/clients/client92/web94/web/maturita/app/config/config.local.neon 

class Container_0276f77300 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/var/www/clients/client92/web94/web/maturita/app',
			'wwwDir' => '/var/www/clients/client92/web94/web/maturita/www',
			'debugMode' => false,
			'productionMode' => true,
			'consoleMode' => false,
			'tempDir' => '/var/www/clients/client92/web94/web/maturita/app/../temp',
		];
	}
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/var/www/clients/client92/web94/web/maturita/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/clients/client92/web94/web/maturita/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=test', null, null, null);
	...
	{
		return new Container_0276f77300_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_0276f77300_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_0276f77300 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('/var/www/clients/client92/web94/web/maturita/app/../temp/cache/latte');
