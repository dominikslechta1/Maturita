...
class Container_2f06cee5c6 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\AdminPresenter' => [1 => ['application.2']],
			...
			'App\Presenters\LoginPresenter' => [1 => ['application.6']],
			'App\Presenters\LogoutPresenter' => [1 => ['application.7']],
		...
		'services' => [
			...
			'application.6' => 'App\Presenters\LoginPresenter',
			'application.7' => 'App\Presenters\LogoutPresenter',
